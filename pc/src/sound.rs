...
impl SoundPlayer {
	pub(crate) fn new() -> Self {
        ...
        let mut background_music = output_handle.play_once(Cursor::new(MUSIC.holiznacc0_mutant_club)).unwrap();
	...
	pub(crate) fn poll(&self) {
	    ...
	    self.background_music.append(Decoder::new_looped(Cursor::new(MUSIC.holiznacc0_mutant_club)).unwrap());}
	}
}
